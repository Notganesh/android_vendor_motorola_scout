...
kernel_so_list=("/vendor/lib/modules/$GKI_PATH/goodix_fod_mmi_u.ko" "/vendor/lib/modules/$GKI_PATH/anc_fps_mmi.ko")
kernel_so_name_list=("goodix_fod_mmi_u.ko" "anc_fps_mmi.ko")
